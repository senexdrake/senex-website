...
type AsyncIterMapFunction<T, R> = (item: T) => Promise<R>
export async function mapAsyncIter<T, R>(asyncIter: NodeJS.AsyncIterator<T>, func: AsyncIterMapFunction<T, R>): Promise<R[]> {
